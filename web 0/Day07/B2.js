...
// // let john = new Player('John', 100); //initialize players
...
// // while (jim.health > 0 && dave.health > 0){ //start the fight
...
// let player1 = new Player({name: 'john', health: 100}); //initialize players
// let player2 = new Player({name: 'dave', health: 100});
// flow outside of a function
...
class Player{
  ...
  let playerJohn = new Player({name: 'John', health: 100}); //initialize players
  let playerDave = new Player({name: 'Dave', health: 100});
  ...
  while (player.health > 0 && player1.health > 0 ) { //start the fight
    ...
    if(Math.floor ( Math.random () * 2 ) === 0 ) {
      ...
      aggressor.attack(defender);
      console.log(`The aggressor is ${aggressor.name}, the defender is ${defender.name}`)
  ...
  console.log(fightToTheDeath (playerJohn, playerDave));